...
/**
 * PositionController - alias của RoleController theo mô hình mới.
 * Endpoint /api/positions tương đương /api/roles.
 * "Position" = "Chức vụ" - dùng cùng data với Role.
 */
@RestController
@RequestMapping("/api/positions")
@RequiredArgsConstructor
@Tag(name = "Position", description = "Quản lý chức vụ nhân viên (Position = Role/Chức vụ)")
