package com.plywood.payroll.modules.pricing.service;
...
public class ProductStepRateService {
    ...
    public byte[] exportExcel(String type) throws java.io.IOException {
        ...
        if ("matrix".equals(type)) {
            ...
            List<ProductionStepResponse> steps = productionStepService.getAll();
            List<ProductQualityResponse> qualities = productQualityService.getAll();
